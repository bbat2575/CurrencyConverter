...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "soft2412.currencyconverter/soft2412.currencyconverter.CurrencyConverter"
...
"%JAVA_EXE%" %JAVA_OPTS% %CURRENCY_CONVERTER_OPTS% %DEFAULT_JVM_OPTS% %*
